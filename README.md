...
```json
{
  ...
  "description": "40-hour battery, active noise cancellation, premium sound quality, comfortable design",
  "country": "US",
  "language": "en"
}
```
...
```json
{
  "meta_title": "Blue Wireless Headphones Pro - Premium Sound Quality",
  "meta_description": "Premium noise-canceling headphones with 40-hour battery life. Perfect for work and travel. Shop now!",
  "meta_keywords": "headphones, wireless, noise-canceling, blue, premium, audio"
}
```
...
{
  "meta_title": "Blue Wireless Headphones Pro - Premium Sound Quality",
  "meta_description": "Premium noise-canceling headphones with 40-hour battery. Shop now at the official store!",
  "meta_keywords": "headphones, wireless, noise-canceling, blue, premium, audio"
}
```
...
```bash
curl http://localhost:8000/test-product/HEADPHONES-BLUE-PRO
```
...
skus = ["HEADPHONES-BLUE", "HEADPHONES-BLACK", "HEADPHONES-SILVER"]
results = []

for sku in skus:
    response = requests.post(
        "http://localhost:8000/seo-meta/sku",
        json={"sku": sku, "language": "en"}
    )
...
```json
{
  ...
  "magento_status": 400,
  "magento_message": "product couldn't be saved, try again later"
}
```
...
**Symptom**: 
```
ERROR:seo_meta_service:Magento update error 400: {"message":"product couldn't be saved, try again later..."}
```
...
This project is a generic Magento SEO metadata generator. Configure it for your Magento store using environment variables.
